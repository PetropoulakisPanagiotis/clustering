...
/* Run model */
int runModel(std::list<Item>& items, int complete, std::ofstream& outputFile, std::string initAlgo, std::string assignAlgo, std::string updateAlgo, std::string& metrice, int numClucsters);
